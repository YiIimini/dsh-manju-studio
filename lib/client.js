...
.mj-bigplay{margin:6px 0 10px;border:1px solid var(--mj-line);border-radius:var(--mj-r-md);overflow:hidden;background:#000}
.mj-bigvid{width:100%;max-height:56vh;display:block;background:#000}
