...
.mj-ptitle{font-size:13.5px;font-weight:700;line-height:1.3;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;letter-spacing:.01em}
.mj-pmeta{font-size:11.5px;color:var(--mj-dim);line-height:1.3;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-variant-numeric:tabular-nums}
									...
									return h("div", {
										...
										h("div", { className: "mj-pinfo" },
											...
											h("div", { className: "mj-pbar" + (pct >= 100 && total ? " done" : "") },
												h("i", { style: { width: pct + "%" } }))),
										p.hasFinal
											? h("span", { className: "mj-pfinal", title: "已成片" + (Number(p.finalCount) > 1 ? "（" + p.finalCount + " 集）" : "") }, "\u2713")
											: null,
										h("button", {
