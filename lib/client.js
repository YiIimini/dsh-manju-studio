			...
			function colProjects() {
				...
				return h("div", { className: "mj-col mj-c1", key: "c1" },
					h(Pane, { title: "成品列表", grow: true,
						right: h("div", { className: "mj-row", style: { gap: 5 } },
							h("span", { className: "mj-tag" }, ps.length + " 部"),
							h("button", {
								className: "mj-refresh" + (refreshing ? " busy" : ""),
								disabled: refreshing || !!busy,
								title: "重新读取项目列表（不会清空当前画面）",
								onClick: refreshAll,
							}, h("span", { className: "mj-refi" }, "\u21bb"), "刷新")) },
...
function colPipeline() {
			...
			return h("div", { className: "mj-root" },
				...
				// 任务日志查看器：左列选文件、右侧看正文。
				// 只用 <pre> + 现成的 .mj-plist/.mj-pre 样式，不引入新依赖。
				logView ? h(Modal, {
					...
					logView.list.length
						? h("div", { className: "mj-row", style: { alignItems: "stretch", gap: 12, minHeight: 0 } },
							...
							h("pre", {
								className: "mj-pre",
								style: { flex: "1 1 auto", minWidth: 0, maxHeight: "58vh" },
							}, logView.text || "（空）"))
						: h("div", { className: "mj-empty" },
							h("span", null, "\u2261"),
							"还没有日志",
